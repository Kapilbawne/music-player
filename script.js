const SONG_LIST = [
  {
    ...
    music: "music/_Tu Hai Kahan(PagalWorld.com.sb).mp3",
    album: "img/forever.jpg",
    background: "img",
  },
  {
    songName: "Chuttamalle",
    music: "music/Chuttamalle(PagalWorld.com.sb).mp3",
    album: "img/mrsandman.jpg",
    background: "img/sky4.jpg",
  },
  {
    songName: "Gulabi Sadi Ani Lali",
    music: "music/Gulabi Sadi Ani Lali(PagalWorld.com.sb).mp3",
    album: "img/intothelight.jpg",
    background: "img/sky2.jpg",
  },
  {
    songName: "Kahani Suno",
    music: "music/Kahani Suno(PagalWorld.com.sb).mp3",
    album: "img/nf.jpg",
    background: "img/black4.jpg",
  },
  {
    songName: "Pehle Bhi Main",
    music: "music/Pehle Bhi Main(PagalWorld.com.sb).mp3",
    album: "img/flames.jpg",
    background: "img/flames2.jpg",
  },
  {
    songName: "Raanjhan",
    music: "music/Raanjhan(PagalWorld.com.sb).mp3",
